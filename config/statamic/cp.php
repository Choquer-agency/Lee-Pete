...
return [
    ...
    */
    ...
    'custom_cms_name' => 'Lee + Pete Vancouver Real Estate Group',

    'custom_logo_url' => [
        'nav' => env('STATAMIC_CUSTOM_LOGO_NAV_URL', '/visuals/leeandpete.png'),
        'outside' => env('STATAMIC_CUSTOM_LOGO_OUTSIDE_URL', '/visuals/leeandpete.png')
    ],

    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', '/visuals/favicon.png'),
